...
public class AdminClient {
     ...
     */
    public List<Map<String, Object>> listTopics() throws FluoriteException {
        ...
        try {
            ...
            if (resp.statusCode() != 200) {
                throw new FluoriteException("Admin API error " + resp.statusCode() + ": " + resp.body());
            }
            return GSON.fromJson(resp.body(), TOPIC_LIST_TYPE);
        } catch (IOException e) {
            throw new FluoriteException("Admin API unreachable: " + e.getMessage(), e);
     ...
     */
    public int registerSchema(int topicId, Map<String, Object> schema) throws FluoriteException {
        ...
        try {
            ...
            if (resp.statusCode() == 409) {
                throw new FluoriteException("Incompatible schema: " + resp.body());
            }
