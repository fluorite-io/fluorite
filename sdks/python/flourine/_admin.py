...
from .exceptions import FlourineException, SchemaException
...
class AdminClient:
    ...
    async def _do(self, req: urllib.request.Request):
        try:
            ...
            raise FlourineException(f"Admin API error {e.code}: {body}")
        except urllib.error.URLError as e:
            raise FlourineException(f"Admin API unreachable: {e.reason}")
