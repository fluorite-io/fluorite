//! Turbine E2E benchmark CLI.
//!
//! Run writer/reader throughput and latency benchmarks.
//!
//! Usage:
//!   turbine-bench writer --scenario baseline
//!   turbine-bench writer --writers 10 --partitions 8 --record-size 1024 --duration 30
//!   turbine-bench report --compare baseline.json --current latest.json
...
#[derive(Parser)]
#[command(name = "turbine-bench")]
#[command(about = "Turbine eventbus benchmark CLI")]
struct Cli {
    #[command(subcommand)]
    command: Commands,
}
