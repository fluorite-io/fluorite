...
#[derive(Parser)]
#[command(name = "flourine", about = "Flourine CLI")]
struct Cli {
    /// Admin API URL
    ...
    #[arg(long, global = true, env = "FLOURINE_API_KEY")]
...
async fn main() -> anyhow::Result<()> {
    let cli = Cli::parse();
    let client = client::FlourineClient::new(&cli.admin_url, cli.api_key.as_deref());
