...
| Payload | apache-avro | fluorite | Speedup |
|---------|-------------|---------|---------|
...
```rust
use fluorite::avro::Schema;
use fluorite::avro::value::{BatchDeserializer, BumpValue};
...
```rust
use fluorite::avro::Schema;
use fluorite::avro::value::{from_datum_slice_bump, BumpValue};
