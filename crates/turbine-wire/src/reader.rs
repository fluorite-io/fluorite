...
fn encode_proto<M: Message>(msg: &M, buf: &mut [u8]) -> usize {
...
fn decode_proto<M: Message + Default>(buf: &[u8], err: &'static str) -> Result<M, DecodeError> {
...
fn from_proto_record(record: proto::Record) -> Record {
    Record {
