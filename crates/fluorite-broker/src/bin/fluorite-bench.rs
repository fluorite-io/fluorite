...
//! Fluorite E2E benchmark CLI.
//!
//! Run writer/reader throughput and latency benchmarks.
//!
//! Usage:
//!   fluorite-bench writer --scenario baseline
//!   fluorite-bench writer --writers 10 --record-size 1024 --duration 30
//!   fluorite-bench report --compare baseline.json --current latest.json
...
#[derive(Parser)]
#[command(name = "fluorite-bench")]
#[command(about = "Fluorite eventbus benchmark CLI")]
struct Cli {
    #[command(subcommand)]
    command: Commands,
}
