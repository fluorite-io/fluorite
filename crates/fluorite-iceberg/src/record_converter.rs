...
//!
//! Uses `fluorite_core::avro::BatchDeserializer` for fast decoding (5-9x faster
...
use fluorite_core::avro::Schema as CoreSchema;
use fluorite_core::avro::value::{BatchDeserializer, BumpValue};
...
/// Converts Fluorite records to Arrow batches with metadata columns.
///
